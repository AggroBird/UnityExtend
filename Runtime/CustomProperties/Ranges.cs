...
namespace AggroBird.UnityExtend
{
    ...
    public struct FloatRange
    {
        ...
        public readonly float LerpUnclamped(float t) => Min + Range * t;
    ...
    public struct DoubleRange
    {
        ...
        public readonly double Clamp(double value) => (value <= Min) ? Min : (value >= Max) ? Max : value;
        public readonly double Lerp(float t) => (t <= 0) ? Min : (t >= 1) ? Max : (Min + Range * t);
        public readonly double Lerp(double t) => (t <= 0) ? Min : (t >= 1) ? Max : (Min + Range * t);
        public readonly double LerpUnclamped(float t) => Min + Range * t;
        public readonly double LerpUnclamped(double t) => Min + Range * t;
